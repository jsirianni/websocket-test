...
```bash
# Connect to default server (localhost:3003)
./client
...
```
2026/01/12 10:00:00 Connecting to ws://localhost:3003/ws
2026/01/12 10:00:00 Connected to ws://localhost:3003/ws
2026/01/12 10:00:30 Connection status: CONNECTED to ws://localhost:3003/ws
2026/01/12 10:01:00 Connection status: CONNECTED to ws://localhost:3003/ws
2026/01/12 10:01:15 Connection lost: websocket: close 1006 (abnormal closure)
2026/01/12 10:01:15 Connection failed: EOF. Retrying in 5s...
2026/01/12 10:01:20 Connecting to ws://localhost:3003/ws
2026/01/12 10:01:20 Connected to ws://localhost:3003/ws
```
